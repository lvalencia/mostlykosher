...
RSpec.describe Admin::ReviewsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all admin_reviews as @admin_reviews" do
      ...
      expect(assigns(:admin_reviews)).to eq([review])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested admin_review as @admin_review" do
      ...
      expect(assigns(:admin_review)).to eq(review)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new admin_review as @admin_review" do
      ...
      expect(assigns(:admin_review)).to be_a_new(Admin::Review)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Admin::Review" do
        expect {
          post :create, params: {admin_review: valid_attributes}, session: valid_session
        }.to change(Admin::Review, :count).by(1)
      end

      it "assigns a newly created admin_review as @admin_review" do
        post :create, params: {admin_review: valid_attributes}, session: valid_session
        expect(assigns(:admin_review)).to be_a(Admin::Review)
        expect(assigns(:admin_review)).to be_persisted
      end

      it "redirects to the created admin_review" do
        post :create, params: {admin_review: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Admin::Review.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved admin_review as @admin_review" do
        post :create, params: {admin_review: invalid_attributes}, session: valid_session
        expect(assigns(:admin_review)).to be_a_new(Admin::Review)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_review" do
        review = Admin::Review.create! valid_attributes
        put :update, params: {id: review.to_param, admin_review: new_attributes}, session: valid_session
        review.reload
      ...
      it "assigns the requested admin_review as @admin_review" do
        review = Admin::Review.create! valid_attributes
        put :update, params: {id: review.to_param, admin_review: valid_attributes}, session: valid_session
        expect(assigns(:admin_review)).to eq(review)
      end
    ...
    context "with invalid params" do
      it "assigns the admin_review as @admin_review" do
        review = Admin::Review.create! valid_attributes
        put :update, params: {id: review.to_param, admin_review: invalid_attributes}, session: valid_session
        expect(assigns(:admin_review)).to eq(review)
      end
